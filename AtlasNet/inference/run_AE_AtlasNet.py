...
parser.add_argument('--model', type=str, default = '/media/storage/guangyao/caixiaoni/master_thesis_backup/AtlasNet/log/atlasnet_separate_cultery/network2.pth',  help='yuor path to the trained model')
